...
async function main() {
    ...
    await mintUSDC("0xF714CA07AFdFa512Da7b18B1A1587738c9230BEb", usdcUnits("100000"));
    
    console.log("Minting 10000 USDC...")
    await usdc.approve(vault.address, usdcUnits("100000"))
    await vault.mint(usdc.address, usdcUnits("10000"), "0")
