...
module.exports = deploymentWithProposal(
  { deployName: "067_deploy_am3curve_usdt", forceDeploy: isFork , tags: ["test", "main"],  dependencies: ["001_core"] },
  async ({
    oracleAddresses,
    assetAddresses,
    ...
    console.log("4. Init and configure new Am3CurveStrategy for USDT")
    const initFunction =
