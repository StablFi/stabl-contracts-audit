...
module.exports = deploymentWithProposal(
  { deployName: "092_deploy_tetu_usdt", forceDeploy: isFork , tags: ["test", "main", "tetu"],  dependencies: ["001_core"] },
  async ({
    oracleAddresses,
    assetAddresses,
    ...
    console.log("TetuStrategyUSDTProxy getting contract");
    ...
    console.log("4. Init and configure new TetuStrategy for USDT")
    const initFunction =
    ...
    await withConfirmation(
      cTetuStrategy.connect(sDeployer)[initFunction](
        ...
        assetAddresses.tetuUsdtSmartVault, // USDT smart vault
