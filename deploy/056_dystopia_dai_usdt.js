...
module.exports = deploymentWithProposal(
  { deployName: "056_dystopia_dai_usdt", forceDeploy: isFork, tags: ["test", "main", "mainnet"], dependencies: ["001_core"] },
  async ({
    oracleAddresses,
    assetAddresses,
    ...
    const dDystopiaStrategyDaiUsdtProxy = await deployWithConfirmation(
      "DystopiaStrategyDaiUsdtProxy"
    );
    const cDystopiaStrategyDaiUsdtProxy = await ethers.getContractAt(
      "DystopiaStrategyDaiUsdtProxy",
      dDystopiaStrategyDaiUsdtProxy.address
    );
    ...
    await withConfirmation(
      cDystopiaStrategy.connect(sDeployer)[initFunction](
        ...
        cVaultProxy.address,
        [assetAddresses.USDC],
        [assetAddresses.DAI, assetAddresses.USDT],
        [
          assetAddresses.dystopiaDystPairDaiUsdt,
          assetAddresses.dystopiaDystPairDaiUsdt,
        ],
        assetAddresses.USDC,
    ...
    await withConfirmation(
      cDystopiaStrategy
        .connect(sDeployer)
        .setParams(
          assetAddresses.dystopiaGuageDaiUsdt,
          assetAddresses.dystopiaDystPairDaiUsdt,
    ...
    return {
      ...
      actions: [
        ...
        },
        {
          ...
          args: [cDystopiaStrategyDaiUsdtProxy.address, true],
        },
      ],
    };
  }
