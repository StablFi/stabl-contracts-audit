...
module.exports = deploymentWithProposal(
  { deployName: "091_deploy_tetu_dai", forceDeploy: isFork, tags: ["test", "main", "tetu"], dependencies: ["001_core"] },
  async ({
    oracleAddresses,
    assetAddresses,
    ...
    console.log("TetuStrategyDAIProxy getting contract");
    ...
    console.log("4. Init and configure new TetuStrategy for DAI")
    const initFunction =
    ...
    await withConfirmation(
      cTetuStrategy.connect(sDeployer)[initFunction](
        ...
        assetAddresses.tetuDaiSmartVault, // DAI smart vault
