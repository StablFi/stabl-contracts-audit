...
module.exports = deploymentWithProposal(
  ...
  async ({
    ...
    const dMeshSwapStrategyUSDTDAIProxy = await deployWithConfirmation(
      "MeshSwapStrategyUSDTDAIProxy"
    );
    const cMeshSwapStrategyUSDTDAIProxy = await ethers.getContractAt(
      "MeshSwapStrategyUSDTDAIProxy",
      dMeshSwapStrategyUSDTDAIProxy.address
    );
    ...
    console.log("4. Init and configure new MeshSwapStrategyDual strategy for DAI/USDT")
    const initFunction =
    ...
    await withConfirmation(
      cMeshSwapStrategyDual.connect(sDeployer)[initFunction](
        ...
        cVaultProxy.address,
        [assetAddresses.USDC],
        [ assetAddresses.USDT, assetAddresses.DAI],
        [assetAddresses.meshSwapUsdtDaiPair,assetAddresses.meshSwapUsdtDaiPair ],
    ...
    // ----------------
    return {
      name: "Switch to new MeshSwapStrategyDual strategy",
      actions: [
        ...
        // 2. Add new MeshSwapStrategyDual strategy to vault
        {
        ...
        },
        {
            ...
            args: [cMeshSwapStrategyUSDTDAIProxy.address, true],
        },
      ],
    };
  }
