...
module.exports = deploymentWithProposal(
  {
    deployName: "095_deploy_balancer_usdt",
    forceDeploy: isFork,
  ...
  async ({ oracleAddresses, assetAddresses, deployWithConfirmation, ethers, getTxOpts, withConfirmation }) => {
    ...
    const dBalancerStrategyProxy = await deployWithConfirmation("BalancerStrategyUSDTProxy");
    console.log("BalancerStrategyUSDTProxy getting contract");
    const cBalancerStrategyProxy = await ethers.getContractAt("BalancerStrategyUSDTProxy", dBalancerStrategyProxy.address);
    ...
    console.log("4. Init and configure new BalancerStrategy for USDT");
    ...
    await withConfirmation(
      cBalancerStrategy.connect(sDeployer)[initFunction](
        ...
        [assetAddresses.USDT], // token0: assets (USDT)
    ...
    await withConfirmation(
      cBalancerStrategy
        ...
        [balancerRequisitesFunction](
          ...
          assetAddresses.balancerPoolIdUsdtAmUsdt,
          assetAddresses.balancerAmUsdtToken
        )
    );
    ...
    // 6. Harvester to accept the USDT (Redundant)
