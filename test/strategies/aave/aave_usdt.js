...
const strategyName = "Aave Supply Strategy USDT";
...
describe("Aave Supply Strategy", function () {
  ...
  beforeEach(async function () {
    ...
    strategy = fixture.cAaveSupplyUsdtStrategyProxy;
    aUSDT = fixture.aUSDT;
  ...
  describe(strategyName + " Strategy", function () {
    it("Should be able to mint " +  primaryStableName + " and it should show up in the " + strategyName + " @fast @fork", async function () {
        ...
        console.log("After Allocation of", primaryStableName , "to", strategyName, " - aUSDT in", strategyName, "Strategy:", usdcUnits((await aUSDT.balanceOf(strategy.address)).toString()).toString());
        ...
        // expect(await aUSDT.balanceOf(strategy.address)).to.be.within(usdcUnits("99.0"), usdcUnits("100.0"));
        expect(await strategy.checkBalance()).to.be.within(usdcUnits("990.0"), usdcUnits("1010.0")); // investments + balance
    });
    ...
    it("Should be able to withdrawAll"+ " @fast @fork", async function () {
      ...
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " - aUSDT in", strategyName, " Strategy:", daiUnitsFormat(await strategy.lpBalance()).toString().toString());
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " -", primaryStableName , "equivalent in", strategyName, " Strategy:", primaryStableUnitsFormat(await  strategy.checkBalance()).toString());
      ...
      console.log("After Withdrawal from",strategyName," - aUSDT in", strategyName, " Strategy:", daiUnitsFormat(await strategy.lpBalance()).toString().toString());
    ...
    it("Should be able to withdraw"+ " @fast @fork", async function () {
      ...
      expect(await strategy.checkBalance()).to.be.within(usdcUnits("4.5"), usdcUnits("5"));
    ...
    it("Should collect rewards"+ " @slow @fork", async() => {
        ...
        // expect(await aUSDT.balanceOf(strategy.address)).to.be.within(usdcUnits("495.0"), usdcUnits("500.0")); // yet to find where amount goes
        ...
        // console.log("After Harvest-  Stargate LP Tokens: ", (await aUSDT.balanceOf(strategy.address)).toString())
