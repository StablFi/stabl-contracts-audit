...
const strategyName = "Aave Supply Strategy DAI";
...
describe("Aave Supply Strategy", function () {
  ...
  beforeEach(async function () {
    ...
    strategy = fixture.cAaveSupplyDaiStrategyProxy;
    aDAI = fixture.aDAI;
  ...
  describe(strategyName + " Strategy", function () {
    it("Should be able to mint " +  primaryStableName + " and it should show up in the " + strategyName + " @fast @fork", async function () {
        ...
        console.log("After Allocation of", primaryStableName , "to", strategyName, " - aDAI in", strategyName, "Strategy:", daiUnits((await aDAI.balanceOf(strategy.address)).toString()).toString());
        ...
        console.log("After Allocation of", primaryStableName , "to", strategyName, " - LP Balance in", strategyName, "Strategy:", daiUnitsFormat(await  strategy.lpBalance()).toString());
        ...
        console.log("After Allocation of", primaryStableName , "to ", strategyName, " -", primaryStableName , "equivalent in Vault:", primaryStableUnitsFormat(await  vault.checkBalance()).toString());
      
        // expect(await aDAI.balanceOf(strategy.address)).to.be.within(usdcUnits("99.0"), usdcUnits("100.0"));
    ...
    it("Should be able to withdrawAll"+ " @fast @fork", async function () {
      ...
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " - aDAI in", strategyName, " Strategy:", daiUnitsFormat(await strategy.lpBalance()).toString().toString());
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " -", primaryStableName , "equivalent in", strategyName, " Strategy:", primaryStableUnitsFormat(await  strategy.checkBalance()).toString());
      ...
      console.log("After Withdrawal from",strategyName," - aDAI in", strategyName, " Strategy:", daiUnitsFormat(await strategy.lpBalance()).toString().toString());
    ...
    it("Should be able to withdraw"+ " @fast @fork", async function () {
      ...
      console.log("After Allocation of", primaryStableName , "to ",strategyName," -", primaryStableName , "in Vault:", primaryStableUnitsFormat(await primaryStable.balanceOf(vault.address)).toString());
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " -", primaryStableName , "in", strategyName, " Strategy:", primaryStableUnitsFormat(await primaryStable.balanceOf(strategy.address)).toString());
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " - aDAI in", strategyName, " Strategy:", usdcUnitsFormat(await strategy.lpBalance()).toString().toString());
      console.log("After Allocation of", primaryStableName , "to ", strategyName, " -", primaryStableName , "equivalent in", strategyName, " Strategy:", primaryStableUnitsFormat(await  strategy.checkBalance()).toString());
    ...
    it("Should collect rewards"+ " @slow @fork", async() => {
        ...
        // expect(await aDAI.balanceOf(strategy.address)).to.be.within(usdcUnits("495.0"), usdcUnits("500.0")); // yet to find where amount goes
        ...
        // console.log("After Harvest-  Stargate LP Tokens: ", (await aDAI.balanceOf(strategy.address)).toString())
