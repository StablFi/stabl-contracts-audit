...
describe("MeshSwap Strategy", function () {
  ...
  beforeEach(async function () {
    ...
    strategy = fixture.cMeshSwapStrategyUSDC;
    meshToken = fixture.meshToken;
    MeshUniToken = fixture.meshSwapUsdc;
  ...
  describe(strategyName + " Strategy", function () {
    ...
    it("Should collect rewards"+ " @slow @fork", async() => {
        ...
        expect(await MeshUniToken.balanceOf(strategy.address)).to.be.within(usdcUnits("345.0"), usdcUnits("350.0"));
