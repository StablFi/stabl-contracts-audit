...
const strategyName = "Balancer Strategy DAI";
const token0Name = "DAI";

const primaryStableName = "USDC";
describe("Balancer Strategy", function () {
  let anna, matt, josh, cash, vault, harvester, governor, usdc, usdt, primaryStable, dai, strategy;
  ...
  beforeEach(async function () {
    ...
    strategy = fixture.cBalancerDaiStrategy;
