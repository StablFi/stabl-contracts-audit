...
@view
@external
def get_dx_stable(balances: uint256[MAX_COINS], amp: uint256, fee: uint256, rates: uint256[MAX_COINS],i: int128, j: int128, dy: uint256) -> uint256:
    precisions: uint256[MAX_COINS] = [1, 1000000000000, 1000000000000]
    underlying: bool = True
    return self.get_dx(3 , balances, amp, fee, rates, precisions, underlying, i, j, dy)